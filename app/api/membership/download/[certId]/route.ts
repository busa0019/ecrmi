...
function getTemplateFile(membershipType: string) {
  ...
  if (t.includes("charter")) return "chartered-fellowship.jpeg";
...
function mergeLayout(templateFile: string): Layout {
  ...
  return {
    ...
    date: override.date || DEFAULT_LAYOUT.date ? { ...(override.date ?? DEFAULT_LAYOUT.date!) } : undefined,
